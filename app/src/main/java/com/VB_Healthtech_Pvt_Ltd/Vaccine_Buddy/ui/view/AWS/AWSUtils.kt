...
import com.catalyist.aws.AWSConstants.BUCKET_NAME
import com.catalyist.aws.AWSConstants.FOLDER_PATH
import com.catalyist.aws.AWSConstants.IDENTITY_POOL_ID
import com.catalyist.aws.AWSConstants.REGION
                        ...
                        try {
                            ...
                            observer?.setTransferListener(
                                AWSCallback(
                                    image,
                                    listner,
                                    folder_path = FOLDER_PATH + image?.name
                                )
                            )
